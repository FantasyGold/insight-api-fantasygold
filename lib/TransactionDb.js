...
var encodedData = require('soop').load('fantasygold-core/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('fantasygold-core/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('fantasygold-core/lib/Address', {
